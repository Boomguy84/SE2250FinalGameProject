...
public class ChooseHero : MonoBehaviour {
    ...
    public void ChooseSwordsman() {
        //set's memory to initialize the swordsman with full health 
        PlayerPrefs.SetFloat("Health",150f);

        //sets score to 0
        UIScript.score = 0;

        //set's memory to remember the chosen character as the swordsman
    ...
    public void ChooseKnight() {
        ...
        //set's memory to remember the chosen character as the knight
    ...
    public void ChooseGino() {
        ...
        //set's memory to remember the chosen character as Gino
