...
public class BombEnemyScript : EnemyScript {
    ...
    public void Move() {
        //set's the animator controller's speed variable to 1 so that it knows to trigger the animation for moving
    ...
    protected override void OnCollisionEnter2D(Collision2D collision) { 
        ...
        //if the game object collides with a hero's bullet, it takes damage using the parent method and destroys the bullet object
        ...
        //if the game object collides with a hero's bomb, it takes damage using the parent method and destroys the bomb object
